...
const boardReducer = {
  ...
  setBoards: (state: IInitialBoardState, action: PayloadAction<IBoard[]>) => {
  ...
  setLang: (state: IInitialBoardState, action: PayloadAction<string>) => {
    state.lang = action.payload;
  },

  setLoading: (state: IInitialBoardState, action: PayloadAction<boolean>) => {
