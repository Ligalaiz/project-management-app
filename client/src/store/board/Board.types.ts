import { MutableRefObject, MouseEvent, ChangeEvent } from 'react';
import { UseFormRegister } from 'react-hook-form';
import { textMap } from '@src/components/Modal/Modal.map';
import { IForm, ILoginValues, IUser } from '@src/store/form/Form.types';
...
export interface ITask {
  ...
  creator: IUser | null;
  executor: IUser | null;
  [key: string]: string | number | IUser | null;
}
