...
const Button: FC<IButton> = ({ type, title, handleClick, dataType, dataName }) => {
  ...
  return (
    <button className={classN} css={btnStyle} onClick={handleClick} data-type={dataType} data-name={dataName}>
      {title}
    </button>
  );
};
